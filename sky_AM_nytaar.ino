...
// Stor: 33cm x2cm hul, 1 stk.
// Lille: 17cm x 2cm hul, 2 stk.
...
// SETTINGS
#define RGB_LED_COUNT             39     // the total number of neopixels on the strip you've attached
#define SPEED_MULTIPLIER          0.003 // the lower this number, the slower all the animations will move
#define RGB_LED_BRIGHTNESS        200   // 0-255, the higher the number the brighter the lights will be ( and more vibrant the colors will be )
